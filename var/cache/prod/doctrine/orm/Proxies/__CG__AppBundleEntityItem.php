...
class Item extends \AppBundle\Entity\Item implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'state', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'priority', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Item' . "\0" . 'done'];
        }
